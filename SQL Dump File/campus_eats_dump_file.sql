...
CREATE TABLE IF NOT EXISTS `Campus_Eats_Fall2020`.`ratings` (
  `idratings_id` INT(11) NOT NULL,
  `restaurant_id` INT(11) NOT NULL,
  `person_id` INT(11) NOT NULL,
  `driver_driver_id` INT(11) NOT NULL,
  `comments` VARCHAR(100) NULL,
  `score` FLOAT NULL,
  PRIMARY KEY (`idratings_id`),
  INDEX `fk_ratings_restaurant1_idx` (`restaurant_id` ASC) VISIBLE,
  INDEX `fk_ratings_person1_idx` (`person_id` ASC) VISIBLE,
  INDEX `fk_ratings_driver1_idx` (`driver_driver_id` ASC) VISIBLE,
  CONSTRAINT `fk_ratings_restaurant1`
    FOREIGN KEY (`restaurant_id`)
    REFERENCES `Campus_Eats_Fall2020`.`restaurant` (`restaurant_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ratings_person1`
    FOREIGN KEY (`person_id`)
    REFERENCES `Campus_Eats_Fall2020`.`person` (`person_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ratings_driver1`
